...
// L'architettura di questo progetto richiede di inserire la chiave API direttamente qui.
...
// Se la chiave API sopra non viene sostituita, la libreria Gemini restituirà un errore nella console del browser.
