...
// FIX: Removed SUPABASE_CONFIG_ERROR as it's no longer exported from supabaseClient.
import { supabase } from './supabaseClient.ts';
// FIX: Removed GEMINI_CONFIG_ERROR as it's no longer exported from geminiService.
import { generateSubtasksFromGemini, generateRoutineTasks, generateMotivationalQuote } from './services/geminiService.ts';
import ConfigurationRequiredView from './components/ConfigurationRequiredView.tsx';

function App() {
  // FIX: Removed the check for configuration errors. If environment variables are missing,
  // the app will throw an error on service initialization, which will be caught by the ErrorBoundary.
  // This simplifies the component and promotes a fail-fast approach.
